...
{
    public partial class havaleTicari : Form
    {
        public havaleTicari()
        {
            InitializeComponent();
        ...
        public static string havaleT2_kaydet = "";
        public static string havaleT3_kaydet = "";
        public static string havaleT4_kaydet = "";
        public static string havaleT5_kaydet = "";
        public static string havaleT6_kaydet = "";
        private void havaleTicari_Load(object sender, EventArgs e)
        {
            comboBoxHavaleYapan.Items.Add("1267");
            comboBoxHavaleYapan.Items.Add("2402");
            comboBoxHavaleYapan.Items.Add("3267");
            comboBoxHavaleYapan.Items.Add("4002");
      
            foreach (int no in hesapAcma.musteri6.HesapNumaralarıListesi)
            {
                comboBoxHavaleYapan.Items.Add(no);
            }

            havaleTicariHesapNo.Items.Add("1267");
            havaleTicariHesapNo.Items.Add("2402");
            havaleTicariHesapNo.Items.Add("3267");
            havaleTicariHesapNo.Items.Add("4002");

            foreach (int no in hesapAcma.musteri6.HesapNumaralarıListesi)
            {
                havaleTicariHesapNo.Items.Add(no);
            }
        }
        private void havaleTOnayla_Click(object sender, EventArgs e)
        {
            ...
            seciliHesapNo1 = Convert.ToInt32(comboBoxHavaleYapan.Items[comboBoxHavaleYapan.SelectedIndex]);
            seciliHesapNo2 = Convert.ToInt32(comboBoxHavaleYapan.Items[comboBoxHavaleYapan.SelectedIndex]);
            seciliHesapNo3 = Convert.ToInt32(comboBoxHavaleYapan.Items[comboBoxHavaleYapan.SelectedIndex]);
            seciliHesapNo4 = Convert.ToInt32(comboBoxHavaleYapan.Items[comboBoxHavaleYapan.SelectedIndex]);
            ...
            seciliHesapNo7 = Convert.ToInt32(havaleTicariHesapNo.Items[havaleTicariHesapNo.SelectedIndex]);
            seciliHesapNo8 = Convert.ToInt32(havaleTicariHesapNo.Items[havaleTicariHesapNo.SelectedIndex]);
            seciliHesapNo9 = Convert.ToInt32(havaleTicariHesapNo.Items[havaleTicariHesapNo.SelectedIndex]);
            seciliHesapNo10 = Convert.ToInt32(havaleTicariHesapNo.Items[havaleTicariHesapNo.SelectedIndex]);

            decimal Tutar_havale = Convert.ToDecimal(havaleTTutar.Text);
            ...
            if (seciliHesapNo1 == 1267)
            {
                if (seciliHesapNo7 == 1267)
                {
                    ...
                    ticari.HavaleYap(hesap2, Tutar_havale);
                    hesap3.Havale(hesap3, Tutar_havale);

                    Islem2.Detay = "Havale işlemi (ticari hesap)";
                    Islem2.HesapNo = 1267;
                    Islem2.IslemTarihi = DateTime.Now;
                    Islem2.Tutar = Convert.ToInt32(havaleTTutar.Text);
                    havaleT2_kaydet += Islem2.IslemTarihi + "  " + Islem2.Detay + "  " + "Miktar:" + Islem2.Tutar + "TL" + "  \n   ";

                    Islem3.Detay = "Hesaba gelen havale işlemi";
                    Islem3.HesapNo = 2402;
                    Islem3.IslemTarihi = DateTime.Now;
                    Islem3.Tutar = Convert.ToInt32(havaleTTutar.Text);
                    havaleT3_kaydet += Islem3.IslemTarihi + "  " + Islem3.Detay + "  " + "Miktar:" + Islem3.Tutar + "TL" + "  \n   ";
                ...
                else if (seciliHesapNo9 == 3267)
                {
                    ...
                    Islem4.Tutar = Convert.ToInt32(havaleTTutar.Text);
                    havaleT4_kaydet += Islem4.IslemTarihi + "  " + Islem4.Detay + "   " + "Miktar:" + Islem4.Tutar + "TL" + "\n ";
                ...
                else if (seciliHesapNo10 == 4002)
                {
                    ...
                    Islem5.Tutar = Convert.ToInt32(havaleTTutar.Text);
                    havaleT5_kaydet += Islem5.IslemTarihi + "  " + Islem5.Detay + "   " + "Miktar:" + Islem5.Tutar + "TL" + "\n ";
                ...
                else
                {
                    ...
                    Islem6.Tutar = Convert.ToInt32(havaleTTutar.Text);
                    havaleT6_kaydet += Islem6.IslemTarihi + "  " + Islem6.Detay + "   " + "Miktar:" + Islem6.Tutar + "TL" + "\n ";
             ...
             else if (seciliHesapNo2 == 2402)
            {
                ...
                else if (seciliHesapNo7 == 1267)
                {
                    ...
                    TicariMusteri ticari = new TicariMusteri();
                    ticari.HavaleYap(hesap3, Tutar_havale);
                    hesap2.Havale(hesap2, Tutar_havale);

                    Islem3.Detay = "Havale işlemi (ticari hesap)";
                    Islem3.HesapNo = 2402;
                    Islem3.IslemTarihi = DateTime.Now;
                    Islem3.Tutar = Convert.ToInt32(havaleTTutar.Text);
                    havaleT3_kaydet += Islem3.IslemTarihi + "  " + Islem3.Detay + "  " + "Miktar:" + Islem3.Tutar + "TL" + "  \n   ";
            ...
            else if (seciliHesapNo3 == 3267)
            {
                if (seciliHesapNo8 == 2402)
                {
                    ...
                    TicariMusteri ticari = new TicariMusteri();
                    ticari.HavaleYap(hesap4, Tutar_havale);
                    hesap3.Havale(hesap3, Tutar_havale);

                    Islem4.Detay = "Havale işlemi (ticari hesap)";
                    Islem4.HesapNo = 3267;
                    Islem4.IslemTarihi = DateTime.Now;
                    Islem4.Tutar = Convert.ToInt32(havaleTTutar.Text);
                    havaleT4_kaydet += Islem4.IslemTarihi + "  " + Islem4.Detay + "  " + "Miktar:" + Islem4.Tutar + "TL" + "  \n   ";
            ...
            else if (seciliHesapNo4 == 4002)
            {
                ...
                if (seciliHesapNo8 == 2402)
                {
                    ...
                    TicariMusteri ticari = new TicariMusteri();
                    ticari.HavaleYap(hesap5, Tutar_havale);
                    hesap3.Havale(hesap3, Tutar_havale);

                    Islem5.Detay = "Havale işlemi (ticari hesap)";
                    Islem5.HesapNo = 4002;
                    Islem5.IslemTarihi = DateTime.Now;
                    Islem5.Tutar = Convert.ToInt32(havaleTTutar.Text);
                    havaleT5_kaydet += Islem5.IslemTarihi + "  " + Islem5.Detay + "  " + "Miktar:" + Islem5.Tutar + "TL" + "  \n   ";
            ...
            else
            {
                ...
                if (seciliHesapNo8 == 2402)
                {
                    ...
                    TicariMusteri ticari = new TicariMusteri();
                    ticari.HavaleYap(hesapAcma.hesap6, Tutar_havale);
                    hesap3.Havale(hesap3, Tutar_havale);

                    Islem6.Detay = "Havale işlemi (ticari hesap)";
                    Islem6.HesapNo = hesapAcma.hesap6.HesapNo;
                    Islem6.IslemTarihi = DateTime.Now;
                    Islem6.Tutar = Convert.ToInt32(havaleTTutar.Text);
                    havaleT6_kaydet += Islem6.IslemTarihi + "  " + Islem6.Detay + "  " + "Miktar:" + Islem6.Tutar + "TL" + "  \n   ";
